/*
This C++ program demonstrates data sharing and communication between
asynchronous tasks using the C++ standard library. In this example, we simulate
a producer and consumer scenario where one task produces data and the other
consumes it using std::promise and std::future for communication and
synchronization.
*/
